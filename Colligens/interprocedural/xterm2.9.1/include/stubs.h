...
typedef struct {} VTFontNames;
typedef struct {} Display;
typedef struct {} IChar;
typedef struct {} ColorRes;
typedef struct {} XColor;
typedef struct {} XTermFonts;
typedef struct {} VTwin;
typedef struct {} Cursor;
typedef struct {} PrinterState;
typedef struct {} PrinterFlags;
typedef struct {} XPoint;
typedef struct {} XtCursorShape;
typedef struct {} XtIntervalId;
typedef struct {} CELL;
typedef struct {} Widget;
typedef struct {} ScrnBuf;
typedef struct {} BellVolume;
typedef struct {} SavedCursor;
typedef struct {} SaveTitle;
typedef struct {} SelectUnit;
typedef struct {} EventMode;
typedef struct {} Time;
typedef struct {} Atom;
typedef struct {} Cardinal;
typedef struct {} GC;
typedef struct {} TKwin;
typedef struct {} Tmodes;
typedef struct {} xtermKeyboardType;
typedef struct {} TModify;
typedef struct {} fontWarningTypes;
typedef struct {} XtGravity;
typedef struct {} CoreClassPart;
typedef struct {} XtermClassPart;
typedef struct {} WidgetClass;
typedef struct {} TekClassPart;
...
typedef struct {} Misc;
typedef struct {} Work;
typedef struct {} TekPart;
typedef struct {} TekScreen;
...
typedef struct {} TekWidget;
typedef struct {} ScrnColors;
typedef struct {} PROTO_XT_ACTIONS_ARGS;
typedef struct {} XEvent;
typedef struct {} XTextProperty;
typedef struct {} XFocusChangeEvent;
typedef struct {} CgsEnum;
typedef struct {} ANSI;
typedef struct {} LineData;
typedef struct {} XKeyEvent;
typedef struct {} CellData;
typedef struct {} PROTO_XT_CALLBACK_ARGS;
typedef struct {} XWindowAttributes;
typedef struct {} OptionHelp;
typedef struct {} XrmOptionDescRec;
typedef struct {} XtAppContext;
typedef struct {} XtInputMask;
typedef struct {} XErrorEvent;
typedef struct {} PROTO_XT_EV_HANDLER_ARGS;
typedef struct {} PtyData;
typedef struct {} PtySelect;
typedef struct {} ScrnPtr;
typedef struct {} XTermRect;
...
typedef struct {} XKeyPressedEvent;
typedef struct {} KeySym;
typedef struct {} Status;
typedef struct {} TekLink;
typedef struct {} Arg;
...
typedef struct {} NCURSES_SCREEN_CB;
typedef struct {} NCURSES_WINDOW_CB;
typedef struct {} mmask_t;
typedef struct {} MEVENT;
typedef struct {} TEXT;
typedef struct {} Item_Options;
typedef struct {} ITEM;
typedef struct {} Menu_Hook;
...
typedef struct {} PROTO_XT_SEL_CB_ARGS;
typedef struct {} XtPointer;
typedef struct {} XICCEncodingStyle;
typedef struct {} XPointer;
typedef struct {} CgsCacheData;
typedef struct {} XtGCMask;
typedef struct {} TermColors;
typedef struct {} CgsCache;
typedef struct {} Drawable;
typedef struct {} XGCValues;
typedef struct {} nl_item;
typedef struct {} BitFunc;
typedef struct {} PARAMS;
typedef struct {} XtActionsRec;
typedef struct {} XtResource;
typedef struct {} ArgList;
typedef struct {} Region;
typedef struct {} XtValueMask;
typedef struct {} XSetWindowAttributes;
typedef struct {} WidgetClassRec;
typedef struct {} XtermWidgetRec;
typedef struct {} noshare;
typedef struct {} XtGeometryResult;
typedef struct {} XdbeSwapInfo;
typedef struct {} TInput;
typedef struct {} XVaNestedList;
typedef struct {} TbInfo;
typedef struct {} XtermMouseModes;
typedef struct {} DECSET_codes;
typedef struct {} XWindowChanges;
typedef struct {} XGraphicsExposeEvent;
typedef struct {} Opaque;
typedef struct {} XIM;
typedef struct {} XIMStyles;
typedef struct {} XIMStyle;
typedef struct {} XIMCallback;
typedef struct {} XtTranslations;
typedef struct {} AtomPtr;
typedef struct {} XtArgVal;
typedef struct {} FontNameProperties;
typedef struct {} XFontProp;
typedef struct {} XftFont;
typedef struct {} XGlyphInfo;
typedef struct {} FcChar32;
typedef struct {} SubResourceRec;
typedef struct {} XTermXftFonts;
typedef struct {} XftPattern;
typedef struct {} XftResult;
...
typedef struct {} UTIDSIZE;
typedef struct {} sigfunc;
...
typedef struct {} ttySize_t;
typedef struct {} TIOCNOTTY;
typedef struct {} TIOCSCTTY;
typedef struct {} TIOCSLTC;
typedef struct {} TIOCLSET;
typedef struct {} TIOCSETP;
typedef struct {} TIOCSETC;
typedef struct {} TIOCSETD;
typedef struct {} TIOCCONS;
typedef struct {} TIOCSPGRP;
...
typedef struct {} XEnterWindowEvent;
...
typedef struct {} OscTextColors;
typedef struct {} XPM_DATA;
typedef struct {} ICON_HINT;
typedef struct {} XpmAttributes;
typedef struct {} IceConn;
typedef struct {} XtCheckpointToken;
typedef struct {} IcePointer;
typedef struct {} XtErrorHandler;
...
typedef struct {} XftChar8;
typedef struct {} XRectangle;
typedef struct {} Visual;
typedef struct {} VTFontEnum;
typedef struct {} TT_BUF_STRUCT;
typedef struct {} TCAPINFO;
...
#define SET_BUTTON1_MOVE_POINT      2001
#define SET_BUTTON2_MOVE_POINT      2002
#define SET_DBUTTON3_DELETE         2003
#define SET_PASTE_IN_BRACKET        2004
#define SET_PASTE_QUOTE             2005
#define SET_PASTE_LITERAL_NL        2006
#define CHARCLASS_H
